...
from .views import PostListView , PostDetailsView , PostCreateView , PostUpdateView , PostDeleteView , UserProfileDetailsView , PostCommentView ,like_post , CommentDeleteView
